...
export function getOrderInfoAdmins(pageNo, pageSize, orderStatus = null){
  let url = "/api-system/orderInfoAdmin/page?pageNo=";
...
export function toNextOrderStatus(orderNo, currentStatus) {
  return request({
    url: "/api-system/orderInfoAdmin/nextStatus/" + orderNo + "/" + currentStatus,
    method: "post"
  })
}
...
export function queryWeixinOrder(orderNo){
  return request({
    url: "/api-system/orderInfoAdmin/wxPayStatus/" + orderNo
  })
}
...
export function cancelOrderNotPay(orderNo){
  return request({
    url: "/api-system/orderInfoAdmin/cancelOrderNotPay/" + orderNo,
    method: "put"
  })
}
...
export function cancelAndRefund(orderNo, reason){
  return request({
    url: "/api-system/orderInfoAdmin/cancelAndRefund/" + orderNo + "?reason=" + reason,
    method: 'put'
  })
}
