...
public class AppRun {
    ...
    public String generate(HttpServletRequest request) {
        ...
        for (Goods good : goods) {
            if(good.getGoodsCategoryName().equals("小吃熟食")){
                goodsPropertyMapper.delete(new QueryWrapper<GoodsProperty>().eq("goods_id", good.getId()));
            }
        }
...
//        }
    ...
    private List<GoodsProperty> generatePropertis() {
        ...
        jialiaoProperty1.setRealPrice(200);
