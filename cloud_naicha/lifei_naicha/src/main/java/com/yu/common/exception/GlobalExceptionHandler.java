...
public class GlobalExceptionHandler {
    ...
    public R exceptionHandler(ServiceException e, HttpServletRequest req) {
        log.error("[异常{}] [{}][{}] {} ", e.getCode(), req.getMethod(), req.getServletPath(), e.getMessage());
        return R.newInstance(e.getCode(), e.getMessage());
    }
    ...
    public R exceptionHandler(Exception e, HttpServletRequest req) {
        ...
        log.error("[异常] [{}][{}] {} {} ", req.getMethod(), req.getServletPath(), message, e.getMessage());
        ...
        return R.newInstance(500, message);
    }
